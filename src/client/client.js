 ...
 */
Client.prototype.getAccessToken = function (authCode) {
 ...
 */
Client.prototype.refreshAccessToken = function (refreshToken) {
    const params = new URLSearchParams()
 ...
 */
Client.prototype.isAccessTokenExpired = function () {
 ...
 * @returns {boolean} True if expired, otherwise false
 */
Client.prototype.isRefreshTokenExpired = function () {
 ...
 */
Client.prototype.getMarketHours = function (markets, date) {
 ...
 */
Client.prototype.getMovers = function (index, direction, change) {
 ...
 */
Client.prototype.getQuotes = function (symbols) {
 ...
 */
Client.prototype.getQuote = function (symbol) {
 ...
 * })
 */
Client.prototype.getPriceHistory = function (symbol, params) {
 ...
 */
Client.prototype.getOptionChain = function getOptionChain(symbol, params) {
 ...
 */
Client.prototype.searchInstruments = function (symbol, projection) {
 ...
 */
Client.prototype.getInstrument = function (cusip) {
 ...
 */
Client.prototype.getAccount = function (accountId) {
 ...
 */
Client.prototype.getPreferences = function (accountId) {
 ...
 */
Client.prototype.updatePreferences = function (accountId, preferences) {
 ...
 */
Client.prototype.getStreamerSubscriptionKeys = function (accountIds) {
 ...
 */
Client.prototype.getUserPrincipals = function (fields) {
 ...
 */
Client.prototype.getOrder = function (accountId, orderId) {
 ...
 * })
 */
Client.prototype.getOrders = function (accountId, params) {
 ...
 * })
 */
Client.prototype.getAllOrders = function (params) {
 ...
 * })
 */
Client.prototype.placeOrder = function (accountId, order) {
 ...
 * @returns {Promise<any>} Success
 */
Client.prototype.replaceOrder = function (accountId, orderId, order) {
 ...
 */
Client.prototype.cancelOrder = function (accountId, orderId) {
 ...
 */
Client.prototype.getSavedOrder = function (accountId, savedOrderId) {
 ...
 */
Client.prototype.getSavedOrders = function (accountId) {
 ...
 * })
 */
Client.prototype.createSavedOrder = function (accountId, savedOrder) {
 ...
 * @returns {Promise<any>} Success
 */
Client.prototype.replaceSavedOrder = function (accountId, savedOrderId, savedOrder) {
 ...
 */
Client.prototype.deleteSavedOrder = function (accountId, savedOrderId) {
 ...
 * @returns {Promise<any>} Success
 */
Client.prototype.createWatchlist = function (accountId, watchlist) {
 ...
 */
Client.prototype.deleteWatchlist = function (accountId, watchlistId) {
 ...
 */
Client.prototype.getWatchlist = function (accountId, watchlistId) {
 ...
 */
Client.prototype.getWatchlists = function (accountId) {
 ...
 */
Client.prototype.getAllWatchlists = function () {
 ...
 * @returns {Promise<any>} Success
 */
Client.prototype.replaceWatchlist = function (accountId, watchlistId, watchlist) {
 ...
 * @returns {Promise<any>} Success
 */
Client.prototype.updateWatchlist = function (accountId, watchlistId, watchlist) {
 ...
 */
Client.prototype.getTransaction = function (accountId, transactionId) {
 ...
 * })
 */
Client.prototype.getTransactions = function (accountId, params) {
